...
class ContextReranker:
    def __init__(self, model_name:str=None, device:str=None, tok=None, mdl=None):
        ...
        if tok is not None and mdl is not None:
            ...
            self.model_name = model_name or "cambridgeltl/SapBERT-from-PubMedBERT-fulltext"
    ...
    def _enc(self, texts, max_len=128):
        x = self.tok(texts, padding=True, truncation=True, max_length=max_len, return_tensors="pt").to(self.device)
